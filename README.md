...
wget https://github.com/dino/dino/releases/download/v0.5.1/dino-0.5.1.tar.gz
wget https://github.com/dino/dino/releases/download/v0.5.1/dino-0.5.1.tar.gz.asc

# Verify the signed archive
gpg --locate-key release-signing@dino.im
gpg --verify dino-0.5.1.tar.gz.asc

# Download the manifest from upstream
curl -O https://raw.githubusercontent.com/dino/dino/master/im.dino.Dino.json

sha512sum dino-0.5.1.tar.gz
